...
* **每首歌獨立主題**：9 套配色與符號（婚禮、百年夢、水電、喵、頭獎、爆紅、進化、
  紀念冊、發票）。
* **卡通圖文演出**：每首歌一組手繪角色（`js/toons.js`），全部用 Canvas 路徑畫成，
  會眨眼、踩拍子跳動、跟著段落演進 —— 百年夢的製圖桌與一層層長高的大樓、水電的
  扳手與吉他、喵布布掉毛、傳奇人生的頒獎台與皇冠、爆紅的直播手機與愛心計數、
  兩對新人的紅線與囍字燈籠、進化的等級條、紀念冊的翻頁與鉛筆、發票的收據捲與
  開獎機。每句歌詞還會跳出對白泡泡或狀聲詞。演出區永遠在字幕上方，空間不夠時
  會自己縮小淡出，不會跟字擠在一起。
